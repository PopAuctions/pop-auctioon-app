...
const TEXT_TYPE_STYLES: Record<TextType, string> = {
  ...
  h2: 'grow-0 self-stretch font-rubik text-[30px] leading-[33px] tracking-[0.1px] md:self-auto md:font-poppins md:text-[36px] md:leading-[44px]',
  ...
  body: 'grow-0 self-stretch font-rubik text-lg leading-[24px] tracking-[0.1px] md:self-auto md:font-poppins md:text-[20px] md:leading-[28px]',
  bloquote:
